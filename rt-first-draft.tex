...
rates $0.015, 0.005$ pre and post $t=50$. In Scenario 3, 
$$
\calR_t = blah.
$$
$\calR_t$ declines from
$2.5$ to $2$ linearly between $t\in[1,60]$, falls to $0.8$ at $t=61$, decreases linearly to $0.6$ until $t=110$, resurges to $1.7$ at $t=111$ and grows
linearly to $2$ until $t=150$, and then drops to $0.9$ at $t=151$ and
