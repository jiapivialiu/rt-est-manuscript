...
overdispersion for negative binomial incidence with size 5. Figure 
...
We find similar results as in Figure \@ref(fig:display-time-long). 
...
$\sim 1$ second. Figure \@ref(fig:display-time-flu) displays 
...
for other settings are shown in Figures \@ref(fig:ci-example-measles-nb) and 
