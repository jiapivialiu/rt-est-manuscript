...
folres = paste0("./src/exp/EpiFilter-master/R files/results/test/")
...
if(!preProc){
  ...
  Iflu = read.csv('src/exp/EpiFilter-master/R files/data/test/Iflu.csv'); Iflu = Iflu[[1]]
  Lflu = read.csv('src/exp/EpiFilter-master/R files/data/test/Lflu.csv'); Lflu = Lflu[[1]]
  genflu = read.csv('src/exp/EpiFilter-master/R files/data/test/genflu.csv'); genflu = genflu[[1]]
  
  # Load sars data preprocessed with 5-day moving average
  Isars = read.csv('src/exp/EpiFilter-master/R files/data/test/Isars.csv'); Isars = Isars[[1]]
  Lsars = read.csv('src/exp/EpiFilter-master/R files/data/test/Lsars.csv'); Lsars = Lsars[[1]]
  gensars = read.csv('src/exp/EpiFilter-master/R files/data/test/gensars.csv'); gensars = gensars[[1]]

}else{
  # Load flu data preprocessed with 5-day moving average
  Iflu = read.csv('src/exp/EpiFilter-master/R files/data/test/IfluFilt.csv'); Iflu = Iflu[[1]]
  Lflu = read.csv('src/exp/EpiFilter-master/R files/data/test/LfluFilt.csv'); Lflu = Lflu[[1]]
  genflu = read.csv('src/exp/EpiFilter-master/R files/data/test/genflu.csv'); genflu = genflu[[1]]
  
  # Load sars data preprocessed with 5-day moving average
  Isars = read.csv('src/exp/EpiFilter-master/R files/data/test/IsarsFilt.csv'); Isars = Isars[[1]]
  Lsars = read.csv('src/exp/EpiFilter-master/R files/data/test/LsarsFilt.csv'); Lsars = Lsars[[1]]
  gensars = read.csv('src/exp/EpiFilter-master/R files/data/test/gensars.csv'); gensars = gensars[[1]]
}
