...
\hypertarget{derivation-of-kullback-leibler-divergence-for-accuracy-comparison}{%
...
\hypertarget{supplmentary-details-on-experimental-settings}{%
...
\hypertarget{experimental-results-on-accuracy-under-misspecification-of-serial-interval-distributions}{%
...
\hypertarget{experimental-settings-for-coverage-comparisons-of-confidence-intervals}{%
...
\hypertarget{experimental-results-on-interval-coverage-comparison}{%
...
Our method \texttt{rtestim} with degrees \(k=1,2,3\) has 100\% coverage at most timepoints except the
...
Our method \texttt{rtestim} with \(k=0\) tends to produce overly narrow intervals, leading to lower coverage.
...
\hypertarget{application-of-rtestim-and-all-competitors-on-real-epidemics}{%
