...
divergence for \(\exp\), e.g. Wainwright and Jordan (\protect\hyperlink{ref-WainwrightJordan2008}{2008}),
\begin{align*}
...
long synthetic epidemics, and \texttt{flu} for short epidemics, inspired by Cori et al. (\protect\hyperlink{ref-cori2013new}{2013})
...
studies; specifically, \((14.9, 3.9)\) for \texttt{measles} (Groendyke, Welch, and Hunter (\protect\hyperlink{ref-groendyke2011bayesian}{2011})),
\((8.4,3.8)\) for \texttt{SARS} (Lipsitch et al. (\protect\hyperlink{ref-lipsitch2003transmission}{2003})), and \((2.6,1.5)\) for
\texttt{flu} (Ferguson et al. (\protect\hyperlink{ref-ferguson2005strategies}{2005}), Boëlle et al. (\protect\hyperlink{ref-boelle2011transmission}{2011})).
...
\caption{The mean KL divergence excluding the first week for measles and SARS epidemics, since \texttt{EpiEstim}with the weekly sliding window does not provide estimates for the first week. Y-axes are on a logarithmic scale.}\label{fig:display-KL-weekly-long}
\end{figure}
...
\caption{The mean KL divergence excluding the first month for measles and SARS epidemics, since \texttt{EpiEstim}with the monthly sliding window does not provide estimates for the first month. Y-axes are on a logarithmic scale.}\label{fig:display-KL-monthly-long}
\end{figure}
...
\item
  interval score (\protect\hyperlink{ref-Bracher_2021}{Bracher et al. 2021}) averaged over all available coordinates.
\end{enumerate}
...
The third metric, interval score (\protect\hyperlink{ref-Bracher_2021}{Bracher et al. 2021}), is defined as
