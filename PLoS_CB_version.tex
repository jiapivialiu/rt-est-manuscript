...
\begin{figure}[!t]
  ...
  %There are
  %four dominant variants throughout the epidemic, Ancestral lineage, Alpha, Delta,
  %and Omicron over time with means 5.1, 3.5, 3.5, 3.0 and standard deviations 4.0,
  %4.5, 2.9, 2.1 respectively, 
...
%\paragraph*{Fig 1.}
%\label{fig:intro-fig}
%{\bf A demonstration of }
%
%\paragraph*{Appendix.}
%\label{Appendix}
%{\bf Supplementary details on methodology and experiments of instantaneous 
