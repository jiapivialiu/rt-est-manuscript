...
We focus on instantaneous reproduction numbers specifically, which is a type of effective reproduction 
...
by Compute Canada with \R\ version 4.3.1. The \R\ packages used for
...
These $\calR_t$ scenarios are illustrated in \autoref{fig:samples-rt}.

\begin{figure}[!ht]
  \centering
  \includegraphics[width=.8\textwidth]{fig/fig_true_rt.png}
  \caption{The effective reproduction numbers for four $\calR_t$ scenarios.} 
  \label{fig:samples-rt}
\end{figure}
...
An example of measles epidemics for each effective reproduction number scenario
with an incidence distribution is displayed in \autoref{fig:samples-measles}; 
SARS epidemics are displayed in \autoref{fig:samples-sars}. 
We also visualize the (over)dispersion level of the following synthetic epidemics 
using signal-to-noise ratios in Appendix. 

\begin{figure}[!ht]
  \centering
  \includegraphics[width=.8\textwidth]{fig/fig_measles_data.png}
  \caption{The sample measles incident cases drawn from Poisson (upper row) or negative
  Binomial (bottom row) distribution across 4 $\calR_t$ scenarios.} 
  \label{fig:samples-measles}
\end{figure}

\begin{figure}[!ht]
  \centering
  \includegraphics[width=.8\textwidth]{fig/fig_sars_data.png}
  \caption{The sample SARS incident cases drawn from Poisson (upper row) or negative
  Binomial (bottom row) distribution across 4 $\calR_t$ scenarios.} 
  \label{fig:samples-sars}
\end{figure}
...
% discusse `degree' of all methods; more details in Discussion section
...
\begin{thebibliography}{10}
  ...
  \bibitem{cori2009temporal}
  Cori A, Bo{\"e}lle PY, Thomas G, Leung GM, Valleron AJ.
  \newblock Temporal variability and social heterogeneity in disease
    transmission: the case of SARS in Hong Kong.
  \newblock PLoS computational biology. 2009;5(8):e1000471.
