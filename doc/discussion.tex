...
% using other data?
%We may also consider other case counts for effective reproduction number estimation if the incidence data is unavailable or not of a good quality. For example, we may use death data with proper ...
